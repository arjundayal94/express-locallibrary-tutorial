//This file creates an express application object, sets up the application with various settings and middleware, and then exports the app from the module.

//All these require calls are for libraries we downloaded using NPM. Path is a core node library for parsing files and directory paths
...
var mongoDB = 'mongodb+srv://a2dayal:<dillamongo>@clusterad-tdzya.azure.mongodb.net/local_library?retryWrites=true&w=majority';
...
// error handler, adds handler methods for errors and HTTP 404 responses.
...
module.exports = app; //This export is useful when we go back to the www file, allows it to be imported there
app.listen(5000, () => {
